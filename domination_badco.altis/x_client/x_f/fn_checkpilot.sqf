// by Bucointesta
//#define __DEBUG__
#define THIS_FILE "fn_checkpilot.sqf"
#include "..\..\x_setup.sqf"
...
if (((_vecnum == 3008) || {(_vecnum == 3101) || {_vecnum == 3102}}) && {!(_enterer in d_attack_pilots)}) exitWith {hintSilent "You need to be an attack pilot to fly this vehicle";false};
