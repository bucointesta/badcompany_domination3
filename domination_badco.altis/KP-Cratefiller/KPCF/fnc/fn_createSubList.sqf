...
switch (_catIndex) do {
    ...
    case 1 : {
        ...
        private _magazines = [_weaponType] call BIS_fnc_compatibleMagazines;
        _magazines append ([configfile >> "CfgWeapons" >> _weaponType >> _glType] call BIS_fnc_compatibleMagazines);
