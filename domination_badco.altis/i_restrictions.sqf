...
d_rangefindersanddesignators = [];
d_standardItems = [];

#ifdef __RHS__
	d_sniper_optics = ["rhsusf_acc_M8541","rhsusf_acc_M8541_d", "rhsusf_acc_M8541_mrds", "rhsusf_acc_M8541_wd", "rhsusf_acc_M8541_low","rhsusf_acc_M8541_low_d","rhsusf_acc_M8541_low_wd","rhsusf_acc_premier_low","rhsusf_acc_premier_anpvs27","rhsusf_acc_premier", "rhsusf_acc_premier_mrds", "rhsusf_acc_LEUPOLDMK4","rhsusf_acc_LEUPOLDMK4_2","rhsusf_acc_LEUPOLDMK4_d","rhsusf_acc_LEUPOLDMK4_wd","rhsusf_acc_LEUPOLDMK4_2_d", "rhsusf_acc_LEUPOLDMK4_2_mrds", "rhs_acc_dh520x56","rhs_acc_pso1m2","rhs_acc_pso1m21", "rhsusf_acc_nxs_3515x50_md", "rhsusf_acc_nxs_3515x50f1_h58", "rhsusf_acc_nxs_3515x50f1_md", "rhsusf_acc_nxs_3515x50f1_h58_sun", "rhsusf_acc_nxs_3515x50f1_md_sun", "rhsusf_acc_nxs_5522x56_md", "rhsusf_acc_nxs_5522x56_md_sun", "rhsusf_acc_ACOG_MDO", "rhs_acc_1pn34"];
#else
	d_sniper_optics = ["optic_AMS","optic_AMS_khk","optic_AMS_snd","optic_DMS","optic_DMS_ghex_F","optic_DMS_weathered_F","optic_DMS_weathered_Kir_F","optic_KHS_hex","optic_KHS_old","optic_KHS_tan","optic_KHS_blk","optic_LRPS","optic_LRPS_ghex_F","optic_LRPS_tna_F", "optic_NVS"];
#endif

d_small_backpacks = ["B_RadioBag_01_hex_F","B_RadioBag_01_oucamo_F","B_RadioBag_01_ghex_F","B_RadioBag_01_black_F","B_RadioBag_01_digi_F","B_RadioBag_01_eaf_F","B_RadioBag_01_mtp_F","B_RadioBag_01_tropic_F","B_RadioBag_01_wdl_F","B_AssaultPack_eaf_F", "B_AssaultPack_wdl_F", "B_AssaultPack_cbr","B_AssaultPack_dgtl","B_AssaultPack_rgr","B_AssaultPack_ocamo","B_AssaultPack_khk","B_AssaultPack_mcamo","B_AssaultPack_sgg","B_AssaultPack_tna_F","B_AssaultPack_blk","B_LegStrapBag_coyote_F","B_LegStrapBag_olive_F","B_LegStrapBag_black_F"];
#ifdef __RHS__
	d_small_backpacks = d_small_backpacks + ["rhsusf_falconii_coy","rhsusf_falconii_mc","rhsusf_falconii", "rhs_rpg_empty",  "rhs_rpg_2", "rhs_rpg_6b2", "rhs_rpg_6b3", "rhs_sidor"];
#endif

d_medium_backpacks = ["B_FieldPack_green_F","B_FieldPack_taiga_F","B_FieldPack_cbr","B_FieldPack_ghex_F","B_FieldPack_ocamo","B_FieldPack_khk","B_FieldPack_oli","B_FieldPack_oucamo","B_TacticalPack_blk","B_TacticalPack_rgr", "B_TacticalPack_ocamo", "B_TacticalPack_mcamo", "B_TacticalPack_oli"];
#ifdef __RHS__
	d_medium_backpacks = d_medium_backpacks + ["rhsusf_assault_eagleaiii_coy","rhsusf_assault_eagleaiii_ocp","rhsusf_assault_eagleaiii_ucp", "rhs_assault_umbts", "rhs_rd54", "rhs_rd54_emr1", "rhs_rd54_flora2", "rhs_rd54_flora1", "rhs_rd54_vest", "rhs_rd54_vest_emr1", "rhs_rd54_vest_flora2", "rhs_rd54_vest_flora1", "rhs_rk_sht_30_emr", "rhs_rk_sht_30_olive"];
#endif
d_large_backpacks = ["B_Carryall_eaf_F","B_Carryall_green_F","B_Carryall_taiga_F","B_Carryall_wdl_F",/*"B_Bergen_dgtl_F","B_Bergen_hex_F","B_Bergen_mcamo_F","B_Bergen_tna_F",*/"B_Carryall_cbr","B_Carryall_ghex_F","B_Carryall_ocamo","B_Carryall_khk","B_Carryall_mcamo","B_Carryall_oli","B_Carryall_oucamo","B_ViperLightHarness_ghex_F","B_ViperLightHarness_hex_F","B_ViperLightHarness_khk_F", "B_ViperLightHarness_oli_F","B_ViperHarness_blk_F","B_ViperHarness_ghex_F","B_ViperHarness_hex_F","B_ViperHarness_khk_F", "B_ViperHarness_oli_F", "B_Kitbag_tan","B_Kitbag_cbr","B_Kitbag_rgr","B_Kitbag_mcamo","B_Kitbag_sgg"];
#ifdef __RHS__
	d_large_backpacks = d_large_backpacks + ["rhsgref_hidf_alicepack", "rhsgref_ttsko_alicepack", "rhsgref_wdl_alicepack", "rhsgref_tortila_specter", "rhs_tortila_black", "rhs_tortila_emr", "rhs_tortila_grey", "rhs_tortila_khaki", "rhs_tortila_olive"];
#endif

#ifdef __RHS__
	d_crewman_only = ["rhsusf_cvc_helmet","rhsusf_cvc_alt_helmet","rhsusf_cvc_green_helmet","rhsusf_cvc_green_alt_helmet","rhsusf_cvc_ess","rhsusf_cvc_green_ess", "rhs_tsh4", "rhs_tsh4_bala", "rhs_tsh4_ess", "rhs_tsh4_ess_bala"];
#else
...
#ifdef __RHS__
	d_medic_only = d_medic_only + ["rhs_medic_bag", "rhsusf_iotv_ocp_Medic","rhsusf_iotv_ucp_Medic","rhsusf_mbav_medic","rhsusf_spc_corpsman","rhsusf_spcs_ocp_medic","rhsusf_spcs_ucp_medic"];
#endif
...
d_sniper_only = ["U_B_FullGhillie_ard","U_B_T_FullGhillie_tna_F","U_B_FullGhillie_lsh","U_B_FullGhillie_sard","U_I_FullGhillie_ard", "U_I_FullGhillie_lsh", "U_I_FullGhillie_sard", "U_B_T_Sniper_F","U_B_GhillieSuit"];
...
d_pilot_only = ["U_I_pilotCoveralls","U_B_PilotCoveralls","U_B_HeliPilotCoveralls","H_PilotHelmetFighter_B","H_PilotHelmetFighter_I","H_PilotHelmetFighter_O","H_PilotHelmetHeli_B","H_PilotHelmetHeli_O","H_CrewHelmetHeli_B","H_CrewHelmetHeli_O","H_CrewHelmetHeli_I","H_PilotHelmetHeli_I"];
#ifdef __RHS__
	d_pilot_only = d_pilot_only + ["RHS_jetpilot_usaf","rhsusf_ihadss","rhsusf_hgu56p","rhsusf_hgu56p_black","rhsusf_hgu56p_green","rhsusf_hgu56p_mask","rhsusf_hgu56p_mask_black","rhsusf_hgu56p_mask_black_skull","rhsusf_hgu56p_mask_green","rhsusf_hgu56p_mask_green_mo","rhsusf_hgu56p_mask_mo","rhsusf_hgu56p_mask_pink","rhsusf_hgu56p_mask_saf","rhsusf_hgu56p_mask_skull","rhsusf_hgu56p_mask_smiley","rhsusf_hgu56p_mask_tan","rhsusf_hgu56p_pink","rhsusf_hgu56p_saf","rhsusf_hgu56p_tan","rhsusf_hgu56p_usa","rhsusf_hgu56p_visor","rhsusf_hgu56p_visor_black","rhsusf_hgu56p_visor_green","rhsusf_hgu56p_visor_mask","rhsusf_hgu56p_visor_mask_black","rhsusf_hgu56p_visor_mask_black_skull","rhsusf_hgu56p_visor_mask_Empire_black","rhsusf_hgu56p_visor_mask_green","rhsusf_hgu56p_visor_mask_green_mo","rhsusf_hgu56p_visor_mask_mo","rhsusf_hgu56p_visor_mask_pink","rhsusf_hgu56p_visor_mask_saf","rhsusf_hgu56p_visor_mask_skull","rhsusf_hgu56p_visor_mask_smiley","rhsusf_hgu56p_visor_mask_tan","rhsusf_hgu56p_visor_pink","rhsusf_hgu56p_visor_saf","rhsusf_hgu56p_visor_tan","rhsusf_hgu56p_visor_usa","rhsusf_hgu56p_visor_white", "rhs_zsh7a_mike_green_alt", "rhs_zsh7a_mike_alt", "rhs_zsh7a_mike_green", "rhs_zsh7a_mike", "rhs_zsh7a_alt", "rhs_zsh7a"];
#endif
...
/*associations between container and his cargo*/
{
	...
	if (_box == d_ammobox_7) then {
		{d_rangefindersanddesignators pushBackUnique ([_x select 0] call BIS_fnc_baseWeapon); false} count _weapons;
		{d_rangefindersanddesignators pushBackUnique (_x select 0); false} count _items;
	};
